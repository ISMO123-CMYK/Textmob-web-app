...
export default function NewStoryModal({ isOpen, onClose, onStoryCreated }) {
 ...
 {/* Modal Card */}
 <div className="relative z-10 w-full max-w-md bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-2xl flex flex-col max-h-[90vh]">
 {/* Header */}
 <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-gray-100 ">
 <div>
 <h3 className="text-base font-black text-gray-900 tracking-tight">Create Story</h3>
 ...
 <p className="text-sm font-bold text-gray-700 ">Upload story media</p>
 ...
 <div>
 <p className="text-xs font-bold text-blue-700 ">Sharing story…</p>
 ...
 <button
 onClick={onClose}
 className="flex-1 py-3 rounded-xl text-sm font-semibold text-gray-500 bg-gray-50 hover:bg-gray-100 active:scale-[0.98] transition-colors"
 >
 Cancel
 </button>
 <button
