...
`);
  ...
  return <Component2140 className={`min-h-screen bg-white dark:bg-gray-900 pb-24 md:pb-8`}><Component2078 className={`relative h-36 md:h-48 bg-gray-100 dark:bg-gray-800 overflow-hidden`}>{t.cover_photo ? <Component2068 src={t.cover_photo} alt={`Cover`} className={`w-full h-full object-cover`} /> : <Component2074 className={`w-full h-full`} style={{
        ...
        <Component2086 className={`flex items-center gap-2 mt-12 md:mt-14`}>{j ? <Component2084 href={`/accountscenter`} data-lexum={true} className={`px-4 py-1.5 rounded-full text-xs font-bold border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors`}>{`Edit profile`}</Component2084> : O ? <_Component15 targetUsername={t.username} currentUsername={O} onUpdate={() => {}} /> : <><Component2084 href={`/auth`} data-lexum={true} className={`px-4 py-1.5 rounded-full text-xs font-bold bg-blue-600 text-white hover:bg-blue-700 active:scale-95 transition-colors`}>{`Log in`}</Component2084><Component2084 href={`/auth`} data-lexum={true} className={`px-4 py-1.5 rounded-full text-xs font-bold border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors`}>{`Sign up`}</Component2084></>}{!j && O && <Component2085 href={`/chats?with=${t.username}`} data-lexum={true} className={`px-4 py-1.5 rounded-full text-xs font-bold bg-blue-600 text-white hover:bg-blue-700 active:scale-95 transition-colors`}>{`Message`}</Component2085>}</Component2086></Component2087><Component2092 className={`mb-3`}><Component2090 className={`flex items-center gap-2 flex-wrap`}><Component2088 className={`text-xl font-bold text-gray-900 dark:text-gray-100 leading-tight`}>
