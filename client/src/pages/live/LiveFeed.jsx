  ...
  if (error) {
    return (
      <div className="p-6 text-center max-w-md mx-auto">
        ...
        <button onClick={loadStreams} className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:underline">Try again</button>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center px-6 py-20 text-center max-w-md mx-auto animate-fade-in">
        <div className="relative mb-6">
          ...
          <span className="absolute inset-0 rounded-full border-2 border-red-300 dark:border-red-500/30 animate-ping opacity-60" />
        </div>
        <h2 className="text-base font-bold text-gray-900 dark:text-gray-100 mb-1.5">No live streams right now</h2>
        <p className="text-xs text-gray-400 dark:text-gray-500 mb-6 max-w-[240px] leading-relaxed">
