    ...
    <Fragment>
      <div className={`relative flex items-center justify-center w-full py-4`}>
        <button
          ...
          className={`absolute left-4 w-9 h-9 rounded-full flex items-center justify-center text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors`}
          aria-label={`Go back`}
        >
      ...
      {e && (
        <div className={`fixed inset-0 z-50 bg-white dark:bg-gray-900 flex flex-col md:bg-black/40 md:items-center md:justify-center`}>
          <div
            className={`flex flex-col w-full h-full md:h-auto md:max-h-[90vh] md:max-w-2xl md:rounded-2xl md:border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden`}
          ...
          >
            <div className={`flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-800 flex-shrink-0`}>
              ...
              <p className={`text-sm font-bold text-gray-900 dark:text-gray-100`}>{`Create post`}</p>
              ...
              <button
                ...
                className={cn(
                  ...
                  c ? `bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed` : `bg-blue-600 text-white hover:opacity-90`
                )}
              >
                {c ? `Posting…` : `Post`}
              </button>
            ...
            <div className={`flex-1 overflow-y-auto px-4 py-4`}>
              <div className={`flex items-start gap-3`}>
                ...
                <div className={`flex-1 min-w-0`}>
                  <div
                    ...
                    className={`min-h-[140px] text-sm leading-relaxed text-gray-800 dark:text-gray-200 focus:outline-none empty:before:content-[attr(data-placeholder)] empty:before:text-gray-300 dark:empty:before:text-gray-600`}
                    style={{
                  ...
                  {quotedPostData && (
                    <div className={`mt-3 p-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 relative`}>
                      <button
                        onClick={() => {
                          setQuotedPostId(null);
                          setQuotedPostData(null);
                        }}
                        className={`absolute top-2 right-2 w-6 h-6 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500 hover:text-red-500 transition-colors`}
                      >
                      ...
                      <div className={`flex items-center gap-2 mb-1`}>
                        <span className={`text-xs font-bold text-gray-900 dark:text-gray-100`}>{`@${quotedPostData.username}`}</span>
                      </div>

                      <p className={`text-xs text-gray-600 dark:text-gray-400 line-clamp-2`}>{quotedPostData.text}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              {k && (
                <div className={`space-y-2 p-3 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-800`}>
                  <div className={`flex items-center justify-between mb-1`}>
                    <p className={`text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider`}>{`Poll`}</p>
                  ...
                  {j.map((e, t) => (
                    <input
                      ...
                      className={`w-full px-4 py-2.5 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm text-gray-800 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900 transition-all`}
                      key={e.id}
                    />
                  ))}
              ...
              {o.length > 0 && (
                <div className={cn(`grid gap-2`, o.length === 1 ? `grid-cols-1` : o.length === 2 ? `grid-cols-2` : `grid-cols-3`)}>
                  {o.map((e, t) => (
                    <div
                      className={cn(`relative rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-800 group`, o.length === 1 ? `aspect-video` : `aspect-square`)}
                      key={t}
                    >
                      {e.type === `image` ? (
                        <img
              ...
              <div className={`flex items-center gap-1 mb-2 overflow-x-auto pb-1 scrollbar-hide`}>
                <label
                  ...
                  className={cn(
                    ...
                    De
                      ...
                      : `text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-blue-600`
                  )}
                >
                  <input
                    ref={ye}
                ...
                <button
                  ...
                  className={cn(
                    ...
                    N ? `bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400` : `text-gray-400 dark:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800`
                  )}
                >
...
const ComposerSheet = ({ onClose: e, title: t, children: n }) => (
  <div className={`fixed inset-0 z-[70] flex flex-col justify-end md:items-center md:justify-center`}>
    ...
    <div className={`relative bg-white dark:bg-gray-900 w-full md:max-w-md rounded-t-2xl md:rounded-2xl border-t md:border border-gray-100 dark:border-gray-800 max-h-[85vh] overflow-y-auto`}>
      ...
      {t && (
        <div className={`flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-800`}>
          <p className={`text-sm font-bold text-gray-900 dark:text-gray-100`}>{t}</p>
          <button onClick={e} className={`w-7 h-7 rounded-full flex items-center justify-center text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors`}>
            <svg viewBox={`0 0 24 24`} className={`w-3.5 h-3.5 fill-none stroke-current`} strokeWidth={`2.5`}>
              <path strokeLinecap={`round`} strokeLinejoin={`round`} d={`M6 18L18 6M6 6l12 12`} />
            </svg>
          </button>
...
const ComposerBtn = ({ onClick: e, title: t, active: n, disabled: r, children: i }) => (
  <button
    ...
    className={cn(
      ...
      r ? `text-gray-200 dark:text-gray-700 cursor-not-allowed` : n ? `bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400` : `text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800`
    )}
  >
    {i}
  </button>
